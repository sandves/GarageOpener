...
var AppComponent = (function () {
    ...
    AppComponent.prototype.open = function () {
        this.garageService.openDoor().subscribe(function (response) { return console.log(response); });
    };
...
var GarageService = (function () {
    ...
    GarageService.prototype.openDoor = function () {
        return this.http.post(this.openGarageUrl, null).map(function (res) { return res.json(); });
    };
